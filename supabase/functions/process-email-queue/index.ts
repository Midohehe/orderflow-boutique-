...
import { EmailSendError, isEmailProviderConfigured, sendEmail } from '../_shared/send-email.ts'
...
Deno.serve(async (req) => {
  ...
  if (!supabaseUrl || !supabaseServiceKey || !isEmailProviderConfigured()) {
    console.error('Missing required environment variables or email provider')
    return new Response(
